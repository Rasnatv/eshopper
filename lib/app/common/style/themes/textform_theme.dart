...
class DTextFormFieldTheme{
  ...
  static InputDecorationTheme lightinputdecorationTheme=InputDecorationTheme(
    ...
    errorBorder: OutlineInputBorder().copyWith(borderRadius: BorderRadius.circular(14),
        borderSide: const BorderSide(width: 1,color: Colors.red)),
    focusedErrorBorder:OutlineInputBorder().copyWith(borderRadius: BorderRadius.circular(14),
